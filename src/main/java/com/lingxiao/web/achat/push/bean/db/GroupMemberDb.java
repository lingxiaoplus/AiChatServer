...
public class GroupMemberDb {
    public static final int PERMESSION_TYPE_NONE = 0; // 默认权限
    public static final int NOTIFY_LEVEL_ADMIN = 1;     //管理员
    public static final int NOTIFY_LEVEL_ADMIN_SU = 100;   //创建者
    ...
    @Column(nullable = false)
    private int permessionType = PERMESSION_TYPE_NONE;
    ...
    public int getPermessionType() {
        return permessionType;
    }

    public void setPermessionType(int permessionType) {
        this.permessionType = permessionType;
    }
